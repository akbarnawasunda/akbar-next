...
check_301 "/archive"                          "/universe"
check_301 "/music/"                           "/music"
check_404 "/music/this-slug-does-not-exist"
check_404 "/definitely-not-a-route"
# Static mount guard: test a missing asset instead of the existing directory.
check_404 "/assets/this-file-does-not-exist"
# ---------------------------------------------------------------------------
