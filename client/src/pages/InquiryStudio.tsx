...
export default function InquiryStudio() {
  ...
  if (!user) return <main className="min-h-screen grid place-items-center p-6"><section className="max-w-md text-center"><h1 className="text-3xl font-semibold">Studio access</h1><p className="mt-3 text-muted-foreground">Sign in to review incoming artist inquiries.</p><Button className="mt-7" onClick={() => startLogin()}>Sign in to continue</Button></section></main>;
