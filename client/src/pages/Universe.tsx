...
export default function Universe() {
  return <div className="nf-page an-archive-page"><NightHeader active="/universe" /><main>
    ...
    <section className="nf-signal-block" id="signal"><div><p className="nf-page-eyebrow">KABAR TERBARU</p><h2>UPDATE<br/>RILISAN.</h2><p>Kabar visual, rilisan, dan jadwal dari kanal resmi.</p></div><FanSignalInline /></section>
