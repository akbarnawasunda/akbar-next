...
export default function Music() {
  ...
  return <div className="nf-page"><NightHeader active="/music" /><main>
    <section className="nf-page-hero" style={{ "--page-image": `url(${featured.artwork || officialBrand.socialPreview})` } as React.CSSProperties}><div><p className="nf-page-eyebrow">MUSIK</p><h1>MUSIK<br/><em>AKBAR.</em></h1><p>Rilisan original dan remix resmi Akbar Nawasunda.</p></div><div className="nf-hero-note"><span>{cms.isLoading ? "MEMUAT RILISAN" : "RILISAN TERBARU"}</span><strong>{featured.title}</strong><a className="nf-text-button" href={featured.href} target="_blank" rel="noreferrer">DENGAR <ArrowUpRight size={15} /></a></div></section>
