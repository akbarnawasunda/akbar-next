...
export default function Music() {
  ...
  return <div className="nf-page"><NightHeader active="/music" /><main>
    ...
    <section className="nf-platform-hub"><div className="nf-platform-hub-copy"><p className="nf-page-eyebrow">PLATFORM RESMI</p><h2>PILIH<br/>PLATFORM.</h2><div className="nf-platform-grid">{allPlatformLinks.map(platform => <a key={platform.label} href={platform.href} target="_blank" rel="noreferrer"><PlatformIcon label={platform.label} />{platform.label}<ArrowUpRight size={15} /></a>)}</div></div></section>
    ...
    <section className="nf-section"><div className="nf-section-title"><div><p className="nf-page-eyebrow">TAUTAN RESMI</p><h2>PLATFORM<br/>RESMI.</h2></div><a className="nf-button" href="https://open.spotify.com/intl-id/artist/7KOQuIQLuxyklLox0RDMMw" target="_blank" rel="noreferrer"><PlatformIcon label="Spotify" /> SPOTIFY</a></div></section>
