...
const labels: Record<InquiryType, { kicker: string; title: string; intro: string }> = {
  booking: { kicker: "BOOKING / PERFORMANCE", title: "BOOKING\nINQUIRY.", intro: "Kirim kebutuhan performance, acara, atau set. Tanggal dan ketersediaan dikonfirmasi setelah inquiry ditinjau." },
  remix: { kicker: "REMIX / CUSTOM ARRANGEMENT", title: "REMIX\nINQUIRY.", intro: "Kirim brief, referensi, dan konteks penggunaan agar arah kreatif dapat ditinjau." },
  collaboration: { kicker: "COLLABORATION", title: "KOLABORASI.", intro: "Jelaskan peran, karya, dan bentuk kerja sama yang kamu ajukan." },
  licensing: { kicker: "LICENSING / USAGE", title: "MUSIC\nLICENSING.", intro: "Ajukan penggunaan musik untuk konten, brand, event, atau proyek lain." },
};
